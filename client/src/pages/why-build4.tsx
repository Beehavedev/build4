      ...
      <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 pl-11">
                <Card className="p-4" data-testid="card-layer-onchain">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed mb-3">
                    Four smart contracts deployed across Base, BNB Chain, and XLayer handle everything that must be trustless and immutable. No server can tamper with these operations. No admin can override them.
                  </p>
              ...
              <div className="pl-11">
                <Card className="p-3 sm:p-4" data-testid="card-comparison-table">
                  <div>
                    ...
                    <ComparisonRow label={t("whyBuild4.comparison.walletLayer")} build4="On-chain (Base, BNB Chain, XLayer)" others="On-chain (various)" />
        ...
        <footer className="border-t py-8 text-center">
          <span className="font-mono text-xs text-muted-foreground">
            BUILD<span className="text-primary">4</span> &mdash; Full-Stack Decentralized AI Agent Economy on Base · BNB Chain · XLayer
          </span>
        </footer>
      </div>
    </div>

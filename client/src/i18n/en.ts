const en = {
  ...
  token: {
    ...
    title: "$BUILD4",
    subtitle: "The token powering decentralized AI agent infrastructure. Multi-chain launch. Hire agents, earn revenue share, govern the platform.",
    supplyBadge: "Supply: 1,000,000,000",
    fairLaunchBadge: "Multi-Chain Fair Launch",
    statSupply: "Total Supply",
    statCurve: "Bonding Curve",
    statLp: "LP Auto-Burned",
    statChain: "BEP-20 Token",
    sectionTokenomics: "Tokenomics",
    tokenomicsDesc: "Multi-chain launch via bonding curves. BNB Chain (Four.meme) + XLayer (Flap.sh). 80% enters the curve, 20% auto-added to LP (burned on graduation).",
    allocFounder: "Founder (Bought from Curve)",
    allocFounderNote: "Purchased from Four.meme bonding curve — distributed to wallets below",
    allocLp: "Liquidity (Auto-Burned)",
    allocLpNote: "Auto-added to PancakeSwap LP on graduation. LP tokens burned by Four.meme",
    allocPublic: "Public Buyers",
    allocPublicNote: "Other buyers on the bonding curve before graduation",
    sectionDistribution: "Founder Distribution (70%)",
    distributionDesc: "The 700M tokens purchased from the bonding curve are distributed across these wallets. All addresses will be published on-chain.",
    distRewards: "Agent Economy Rewards",
    distRewardsNote: "24-month release — rewards for hiring agents, top performers, referrals",
    distTreasury: "Treasury / Operations",
    distTreasuryNote: "Platform development, server costs, buybacks. Multisig wallet",
    distMarketing: "Marketing & Growth",
    distMarketingNote: "KOLs, exchange listings, campaigns, community airdrops",
    distReserve: "Founder Reserve",
    distReserveNote: "Strategic reserve for future exchange listings and partnerships",
    distTeam: "Team",
    distTeamNote: "6-month cliff, 12-month linear vest",
    sectionUtility: "Token Utility",
    utilDiscount: "Hire Agents at a Discount (Planned)",
    utilDiscountDesc: "Pay with $BUILD4 instead of BNB for a discount on agent deployment fees",
    utilRevenue: "Revenue Share (Planned)",
    utilRevenueDesc: "Stake $BUILD4 to earn a share of platform fees collected from agent activity",
    ...
    transLp: "LP Auto-Burned",
    transLpDesc: "LP tokens automatically burned by Four.meme on graduation — permanently locked",
    transWallets: "Public Wallets",
    transWalletsDesc: "All allocation wallets published with live on-chain balances",
    transVesting: "Team Vesting",
    transVestingDesc: "Team tokens in a vesting contract — 6-month cliff, 12-month linear vest",
    ...
    contractSoon: "Coming soon",
    hireAgent: "Hire an Agent",
    footer: "Decentralized AI Agent Infrastructure on BNB Chain & XLayer",
  },
};

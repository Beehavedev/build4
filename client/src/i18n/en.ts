const en = {
  ...
  home: {
    ...
    roadmap: {
      ...
      title: "Concrete path to",
      titleHighlight: "decentralized inference",
      subtitle: "A multi-provider inference layer where agents choose their compute source.",
      level1: {
        level: "Level 1",
        label: "Now",
    ...
    provider: {
      sectionLabel: "Provider Abstraction",
      title: "One interface,",
      titleHighlight: "any compute",
      subtitle: "The inference layer abstracts away provider details. Agents call a single API and the system routes to the optimal compute source based on cost, speed, and verifiability.",
      items: [
        "OpenAI / Anthropic (centralized fallback)",
        "Bittensor Subnet 18 (decentralized LLM)",
        "io.net / Akash (distributed GPU)",
        "EZKL / zkML (verifiable inference)",
      ],
    },
    cta: {

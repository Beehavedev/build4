const en = {
  ...
  token: {
    ...
    title: "$BUILD4",
    subtitle: "The token powering decentralized AI agent infrastructure. Hire agents, earn revenue share, govern the platform.",
    supplyBadge: "Supply: 1,000,000,000",
    fairLaunchBadge: "Fair Launch on Four.meme",
    statSupply: "Total Supply",
    statCurve: "Bonding Curve",
    statLp: "LP Auto-Burned",
    statChain: "BEP-20 Token",
    sectionTokenomics: "Tokenomics",
    tokenomicsDesc: "Launched on Four.meme. 80% of supply enters the bonding curve, 20% auto-added to PancakeSwap LP (burned on graduation).",
    ...
    contractSoon: "Coming soon — launching on Four.meme",

const en = {
  ...
  token: {
    chain: "Base Chain",
    title: "$BUILD4",
    subtitle: "The token powering decentralized AI agent infrastructure on Base. Fair launch. Hire agents, earn revenue share, govern the platform.",
    supplyBadge: "Supply: 1,000,000,000",
    fairLaunchBadge: "Fair Launch on Base",
    statSupply: "Total Supply",
    statFounder: "Ecosystem",
    statLp: "Liquidity Pool",
    statPublic: "Public Sale",
    statChain: "ERC-20 Token",
    sectionTokenomics: "Tokenomics",
    tokenomicsDesc: "1 billion $BUILD4 tokens launched on Base chain. 80% ecosystem allocation, 10% liquidity, 10% public buyers.",
    allocFounder: "Ecosystem Allocation",
    allocFounderNote: "Distributed across rewards, treasury, marketing, reserve, and team wallets",
    allocLp: "Liquidity Pool",
    allocLpNote: "Paired with ETH on Uniswap / Aerodrome on Base. LP tokens locked",
    allocPublic: "Public Buyers",
    allocPublicNote: "Available for public purchase on DEX after launch",
    sectionDistribution: "Ecosystem Distribution (80%)",
    distributionDesc: "800M tokens allocated across ecosystem wallets. All addresses will be published on-chain.",
    ...
    transLp: "LP Locked",
    transLpDesc: "Liquidity pool tokens locked — permanently securing trading liquidity on Base",
    transWallets: "Public Wallets",
    transWalletsDesc: "All allocation wallets published with live on-chain balances on BaseScan",
    ...
    contractSoon: "Coming soon — launching on Base",
    hireAgent: "Hire an Agent",
    footer: "Decentralized AI Agent Infrastructure on Base Chain",
  },
};

const en = {
  ...
  home: {
    ...
    explore: "Explore",
    stats: {
      onchainUsers: "On-Chain Users",
      activeAgents: "Active Agents",
      transactions: "Transactions",
      transactionsDay: "Transactions/Day",
      skillsCreated: "Skill Purchases",
  ...
  whyBuild4: {
    ...
    comparisonValues: {
      ...
      costBuild4: "70-85% cheaper via decentralized GPU markets",
      costOthers: "Full price from centralized providers",
      verificationLabel: "Verifiable computation",
      verificationBuild4: "zkML proofs via Ritual. Cryptographic verification.",
  ...
  token: {
    ...
    utilDiscount: "Hire Agents at a Discount",
    utilDiscountDesc: "Pay with $BUILD4 instead of BNB and get 20% off — $479 vs $599 per agent",
    utilRevenue: "Revenue Share",
    utilRevenueDesc: "Stake $BUILD4 to earn a cut of the 20% profit fees collected from trading agents",
    utilPremium: "Premium Agent Roles",
    utilPremiumDesc: "Unlock exclusive roles like Alpha Hunter and Whale Tracker by holding $BUILD4",
    utilBoost: "Agent Boost",
    utilBoostDesc: "Stake tokens on your agent for priority in the sniper queue and higher trade allocation",
    utilGov: "Governance",
    utilGovDesc: "Vote on fee structures, new agent roles, and platform direction",
    utilBurn: "Buyback & Burn",
    utilBurnDesc: "30% of all agent hire fees buy $BUILD4 from the market — 50% burned, 50% to staking rewards",
    sectionFlywheel: "Revenue Flywheel",
    fly1: "Users hire agents",
    fly1sub: "$599 in BNB",
    fly2: "30% of fees buy $BUILD4",
    fly2sub: "From open market",
    fly3: "50% burned, 50% to stakers",

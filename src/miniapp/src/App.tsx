...
// REVERTED 2026-05-13: lazy-loading was suspected of breaking the
// Wallet menu + ASTER/HL balance display in production right before a
// demo. Rolled back to eager imports for safety; compression + poll-
// throttle changes remain in place. Re-attempt lazy splitting later
// with proper QA in a Telegram WebView (not just desktop browser).
...
export default function App() {
  ...
  const overflowItems: { id: Page; label: string; icon: string }[] = [
    ...
    // the Telegram mini-app so the operator's personal Telegram account can't
    // collide with the singleton house agent.
  ]

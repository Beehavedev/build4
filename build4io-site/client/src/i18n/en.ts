const en = {
  ...
  token: {
    ...
    tokenomicsDesc: "1 billion $B4 tokens launched on BNB Chain via Four.meme. 70% ecosystem allocation, 10% liquidity, 20% public buyers.",
    ...
    allocLpNote: "Paired with BNB on Four.meme. LP tokens burned (permanently locked)",
    ...
    utilDiscountDesc: "Pay platform & deployment fees in $B4 instead of BNB and get a permanent discount on every agent you run",
    utilRevenue: "Stake for Fee Discounts (Planned)",
    utilRevenueDesc: "Stake $B4 to unlock tiered fee discounts on Aster, Hyperliquid, four.meme, Topaz and Polymarket trades — the more you stake, the less you pay",
    utilPremium: "Premium Agent Roles (Planned)",
    utilPremiumDesc: "Access to additional agent roles and capabilities by holding $B4",
    ...
    utilBurn: "Buyback & Burn — The Flywheel (Planned)",
    utilBurnDesc: "A slice of every fee the platform collects across Aster, HL, four.meme, Topaz and Polymarket is used to buy $B4 from the open market and burn it. Real revenue → real supply shrink.",
    sectionFlywheel: "Revenue Flywheel (Planned)",
    fly1: "Users hire agents",
    fly1sub: "$19.99/month subscription",
    fly2: "Portion of fees buy $B4",
    ...
    transLp: "LP Locked",
    transLpDesc: "LP tokens burned by Four.meme — liquidity permanently locked on BNB Chain",
    ...
    vestLpSchedule: "Deployed at launch · LP tokens burned by Four.meme",
    vestLpDetail: "Paired with BNB on Four.meme. LP tokens are automatically burned — liquidity is permanently locked forever",
    ...
    contractSoon: "Live on BNB Chain via Four.meme",

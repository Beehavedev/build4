        ...
        <nav className="sticky top-0 z-50 bg-background/90 backdrop-blur-xl border-b">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-2">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link href="/competition" className="text-xs font-mono tracking-wide transition-colors hover:opacity-80" style={{ color: "#3FE94A" }} data-testid="link-competition">4meme competition</Link>
              <LanguageSwitcher />
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t bg-background/95 backdrop-blur-xl px-4 py-3 space-y-1">
              ...
              <Link href="/competition" onClick={() => setMobileMenuOpen(false)} className="block py-2 text-sm font-mono" style={{ color: "#3FE94A" }} data-testid="link-competition-mobile">4meme competition</Link>
            </div>
          )}
        </nav>

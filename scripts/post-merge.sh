...
# Prisma schema for this project lives at src/_prisma_bot/schema.prisma and is
...
#
# That duplicate is now archived at src/_prisma_bot/schema.prisma and is
...
# `npx prisma db push --schema=src/_prisma_bot/schema.prisma --accept-data-loss`
# after weighing the risk.
echo "[post-merge] prisma db push intentionally skipped — Render owns the bot DB schema (src/_prisma_bot/)"

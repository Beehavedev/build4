...
- **Flap.sh (BSC)**: Portal `0xe2cE6ab80874Fa9Fa2aAE65D277Dd6B8e65C9De0`, uses `newTokenV2` with struct params. Token impl `0x29e6383f0ce68507b5a72a53c2b118a118332aa8`. Requires vanity salt mining (CREATE2 address ending in `7777` for tax tokens). Params: `dexThresh=1, taxRate=100 (1%), migratorType=1 (V2)`. Salt mined locally using `mineVanitySalt()` function (~50K iterations, ~5 seconds).

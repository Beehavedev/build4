...
- **AI Trading**: Full-auto autonomous agent scans all 18 pairs every cycle, ranks by EMA/RSI signal strength, picks best opportunities. Users control only max risk %, max leverage, and max open positions. Agent decides pair, direction, leverage, and timing independently

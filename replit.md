...
- `/analytics` — Visitor analytics dashboard tracking humans vs AI agents, traffic charts, top pages, agent user-agents, and recent visitor logs
- `/services` — Unified services dashboard with 4 income-generating tabs: Inference API, Bounty Board, Subscriptions, Data Marketplace
...
- **Routes**: `server/services-routes.ts` handles all 4 features
